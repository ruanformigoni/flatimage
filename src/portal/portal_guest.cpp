...
int main(int argc, char** argv)
{
  ...
  auto path_file_fifo_stdout = create_fifo(fs::path{str_dir_mount} / "portal" / "fifo", "stdout");
  auto path_file_fifo_stderr = create_fifo(fs::path{str_dir_mount} / "portal" / "fifo", "stderr");
  auto path_file_fifo_exit = create_fifo(fs::path{str_dir_mount} / "portal" / "fifo", "exit");
